...
<html class="no-js" lang="de">
  <head>
    ...
    <noscript>
      <meta
        http-equiv="refresh"
        content="0; URL=https://www.seppmed.de/it-sicherheit-und-software-security/"
      />
    </noscript>
    ...
    <link
      rel="preload"
      href="/fonts/source-code-pro-v21-latin-regular.woff2"
      as="font"
      type="font/woff2"
      crossorigin
    />
    <link
      rel="preload"
      href="/fonts/source-code-pro-v21-latin-700.woff2"
      as="font"
      type="font/woff2"
      crossorigin
    />
    <style>
      ...
      @font-face {
        ...
        src: local(""),
          url("/fonts/source-code-pro-v21-latin-regular.eot?#iefix")
          ...
          url("/fonts/source-code-pro-v21-latin-regular.svg#SourceCodePro")
            format("svg");
      }
      ...
      @font-face {
        ...
        src: local(""),
          url("/fonts/source-code-pro-v21-latin-700.eot?#iefix")
            format("embedded-opentype"),
          ...
          url("/fonts/source-code-pro-v21-latin-700.svg#SourceCodePro")
            format("svg");
      }
    ...
    <link
      rel="prefetch"
      href="https://www.seppmed.de/it-sicherheit-und-software-security/"
      as="document"
    />
  </head>
  ...
  <body>
    ...
    <script>
      ...
      (function(k,e){var C=function(b,d){var c={},f;for(f in b)c[f]=d[f]&&0===d[f].length%2?d[f].concat(b[f]):b[f];return c},t=function(b){for(var d={},c=0;c<b.length;c++)d[b[c].toUpperCase()]=b[c];return d},x=function(b,d){return"string"===typeof b?-1!==r(d).indexOf(r(b)):!1},r=function(b){return b.toLowerCase()},w=function(b,d){if("string"===typeof b)return b=b.replace(/^\s\s*/,"").replace(/\s\s*$/,""),"undefined"===typeof d?b:b.substring(0,255)},p=function(b,d){for(var c=0,f,n,g,a,m,l;c<d.length&&!m;){var y=
      d[c],z=d[c+1];for(f=n=0;f<y.length&&!m;)if(m=y[f++].exec(b))for(g=0;g<z.length;g++)l=m[++n],a=z[g],"object"===typeof a&&0<a.length?2===a.length?this[a[0]]="function"==typeof a[1]?a[1].call(this,l):a[1]:3===a.length?this[a[0]]="function"!==typeof a[1]||a[1].exec&&a[1].test?l?l.replace(a[1],a[2]):e:l?a[1].call(this,l,a[2]):e:4===a.length&&(this[a[0]]=l?a[3].call(this,l.replace(a[1],a[2])):e):this[a]=l?l:e;c+=2}},u=function(b,d){for(var c in d)if("object"===typeof d[c]&&0<d[c].length)for(var f=0;f<d[c].length;f++){if(x(d[c][f],
      b))return"?"===c?e:c}else if(x(d[c],b))return"?"===c?e:c;return b},A={ME:"4.90","NT 3.11":"NT3.51","NT 4.0":"NT4.0",2E3:"NT 5.0",XP:["NT 5.1","NT 5.2"],Vista:"NT 6.0",7:"NT 6.1",8:"NT 6.2","8.1":"NT 6.3",10:["NT 6.4","NT 10.0"],RT:"ARM"},B={browser:[[/\b(?:crmo|crios)\/([\w\.]+)/i],["version",["name","Chrome"]],[/edg(?:e|ios|a)?\/([\w\.]+)/i],["version",["name","Edge"]],[/(opera mini)\/([-\w\.]+)/i,/(opera [mobiletab]{3,6})\b.+version\/([-\w\.]+)/i,/(opera)(?:.+version\/|[\/ ]+)([\w\.]+)/i],["name",
      ...
      /(seamonkey|k-meleon|icecat|iceape|firebird|phoenix|palemoon|basilisk|waterfox)\/([-\w\.]+)$/i,/(firefox)\/([\w\.]+)/i,/(mozilla)\/([\w\.]+) .+rv:.+gecko\/\d+/i,/(polaris|lynx|dillo|icab|doris|amaya|w3m|netsurf|sleipnir|obigo|mosaic|(?:go|ice|up)[\. ]?browser)[-\/ ]?v?([\w\.]+)/i,/(links) \(([\w\.]+)/i],["name","version"]],cpu:[[/(?:(amd|x(?:(?:86|64)[-_])?|wow|win)64)[;\)]/i],[["architecture","amd64"]],[/(ia32(?=;))/i],[["architecture",r]],[/((?:i[346]|x)86)[;\)]/i],[["architecture","ia32"]],[/\b(aarch64|arm(v?8e?l?|_?64))\b/i],
      [["architecture","arm64"]],[/\b(arm(?:v[67])?ht?n?[fl]p?)\b/i],[["architecture","armhf"]],[/windows (ce|mobile); ppc;/i],[["architecture","arm"]],[/((?:ppc|powerpc)(?:64)?)(?: mac|;|\))/i],[["architecture",/ower/,"",r]],[/(sun4\w)[;\)]/i],[["architecture","sparc"]],[/((?:avr32|ia64(?=;))|68k(?=\))|\barm(?=v(?:[1-7]|[5-7]1)l?|;|eabi)|(?=atmel )avr|(?:irix|mips|sparc)(?:64)?\b|pa-risc)/i],[["architecture",r]]],device:[[/\b(sch-i[89]0\d|shw-m380s|sm-[pt]\w{2,4}|gt-[pn]\d{2,4}|sgh-t8[56]9|nexus 10)/i],
      ...
      /(windows)[\/ ]?([ntce\d\. ]+\w)(?!.+xbox)/i],["name",["version",u,A]],[/(win(?=3|9|n)|win 9x )([nt\d\.]+)/i],[["name","Windows"],["version",u,A]],[/ip[honead]{2,4}\b(?:.*os ([\w]+) like mac|; opera)/i,/cfnetwork\/.+darwin/i],[["version",/_/g,"."],["name","iOS"]],[/(mac os x) ?([\w\. ]*)/i,/(macintosh|mac_powerpc\b)(?!.+haiku)/i],[["name","Mac OS"],["version",/_/g,"."]],[/droid ([\w\.]+)\b.+(android[- ]x86)/i],["version","name"],[/(android|webos|qnx|bada|rim tablet os|maemo|meego|sailfish)[-\/ ]?([\w\.]*)/i,
      ...
      /(hurd|linux) ?([\w\.]*)/i,/(gnu) ?([\w\.]*)/i,/\b([-frentopcghs]{0,5}bsd|dragonfly)[\/ ]?(?!amd|[ix346]{1,2}86)([\w\.]*)/i,/(haiku) (\w+)/i],["name","version"],[/(sunos) ?([\w\.\d]*)/i],[["name","Solaris"],"version"],[/((?:open)?solaris)[-\/ ]?([\w\.]*)/i,/(aix) ((\d)(?=\.|\)| )[\w\.])*/i,/\b(beos|os\/2|amigaos|morphos|openvms|fuchsia|hp-ux)/i,/(unix) ?([\w\.]*)/i],["name","version"]]},h=function(b,d){"object"===typeof b&&(d=b,b=e);if(!(this instanceof h))return(new h(b,d)).getResult();var c=b||
      ("undefined"!==typeof k&&k.navigator&&k.navigator.userAgent?k.navigator.userAgent:""),f=d?C(B,d):B,n;this.getBrowser=function(){var a={};a.name=e;a.version=e;p.call(a,c,f.browser);var m=a.version;m="string"===typeof m?m.replace(/[^\d\.]/g,"").split(".")[0]:e;a.major=m;return a};this.getCPU=function(){var a={};a.architecture=e;p.call(a,c,f.cpu);return a};this.getDevice=function(){var a={};a.vendor=e;a.model=e;a.type=e;p.call(a,c,f.device);return a};this.getEngine=function(){var a={};a.name=e;a.version=
      e;p.call(a,c,f.engine);return a};this.getGPU=function(){var a={};a.vendor=e;a.model=e;n&&p.call(a,n,f.gpu);return a};this.getOS=function(){var a={};a.name=e;a.version=e;p.call(a,c,f.os);return a};this.getResult=function(){return{ua:this.getUA(),browser:this.getBrowser(),engine:this.getEngine(),os:this.getOS(),device:this.getDevice(),cpu:this.getCPU(),gpu:this.getGPU()}};this.getRenderer=function(){return n};this.setRenderer=function(a){n=a;return this};this.getUA=function(){return c};this.setUA=function(a){c=
      "string"===typeof a&&255<a.length?w(a,255):a;return this};this.setUA(c);if("undefined"!==typeof k&&k.document){var g=document.createElement("canvas");g=g.getContext?g.getContext("webgl2")||g.getContext("webgl")||g.getContext("experimental-webgl"):e;this.setRenderer(g&&g.getParameter&&g.getExtension&&g.getExtension("WEBGL_debug_renderer_info")?g.getParameter(g.getExtension("WEBGL_debug_renderer_info").UNMASKED_RENDERER_WEBGL):e)}return this};h.VERSION="1.0.2-gpu-experimental";h.BROWSER=t(["name","version",
      "major"]);h.CPU=t(["architecture"]);h.DEVICE=t("model vendor type console mobile smarttv tablet wearable embedded".split(" "));h.ENGINE=h.OS=t(["name","version"]);"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=h),exports.UAParser=h):"function"===typeof define&&define.amd?define(function(){return h}):"undefined"!==typeof k&&(k.UAParser=h);var q="undefined"!==typeof k&&(k.jQuery||k.Zepto);if(q&&!q.ua){var v=new h;q.ua=v.getResult();q.ua.get=function(){return v.getUA()};
      q.ua.set=function(b){v.setUA(b);b=v.getResult();for(var d in b)q.ua[d]=b[d]}}})("object"===typeof window?window:this);
    </script>
